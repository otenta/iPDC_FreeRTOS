...
struct Lower_Layer_Details {
    ...
    TaskHandle_t thread_id; /* Assuming FreeRTOS Task Handle */
...
void* UL_tcp(void *pvParameters); /* Modified to match FreeRTOS Task signature */

void* UL_tcp_connection(void * newfd);

void* UL_udp(void *pvParameters); /* Modified to match FreeRTOS Task signature */
